                ...
                <div class="panel-body">
                    ...
                    @foreach($userFollows as $userFollow)
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                {{ $userFollow->name }}<br>
                                <a href="{{ route('un-follow.edit', ['id' => $userFollow->id]) }}"><button class="btn btn-warning btn-xs un-follow" id="{{ $userFollow->id }}">Unfollow</button></a>
                            </div>
                        </div>
                        <hr>
                    @endforeach
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-11">
                                @if ($activity->action_type == config('common.activity.activity_follow') ||
                                    ...
                                    <p>
                                        {{ trans_choice('client/name.activity', $activity->action_type,
