...
class ResultController extends Controller
{
    ...
    {
        $numberRecord = config('common.result.default_number_record_result');
        ...
        $lessonResults = LessonResult::with('lesson.category')
            ->orderBy('lesson_id', $sortStyle)->paginate($numberRecord);
